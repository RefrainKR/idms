...
export class Star2Module extends BaseGachaModule {
    ...
    renderUI() {
        ...
        if (activeSubTab === 'res-2s-collection') {
            ...
            renderSpecificBarResult(dpSpecific, VIEW_MODE.star2, { chart: 'resultChartSpecific2' }, `특정 픽업 기대 수: 약 <strong>${expected.toFixed(3)}장</strong><span style="font-size:0.85rem; color:#dc3545;">(천장 포함 버튼이 활성화 되어있는지 주의하세요.)</span><br>`, this.chartRefs.specific);
        }
    }
