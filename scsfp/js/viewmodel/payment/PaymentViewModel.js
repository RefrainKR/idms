...
export class PaymentViewModel {
    ...
    bindCurrencyToggle() {
        ...
        toggleBtn.addEventListener('click', () => {
            const currentCurrency = toggleBtn.dataset.currency;
            const newCurrency = currentCurrency === 'JPY' ? 'KRW' : 'JPY';

            // 버튼 텍스트 변경
            toggleBtn.textContent = newCurrency === 'JPY' ? '엔화 (¥)' : '원화 (₩)';
     ...
     */
    renderPackageTables() {
        this.view.renderPackageTable(PACKAGES, this.model.exchangeRate.value);
